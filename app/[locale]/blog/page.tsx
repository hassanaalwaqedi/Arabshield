...
export default function BlogPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-white" dir="rtl">
            ...
            {/* Categories Filter */}
            <div className="sticky top-20 z-30 bg-slate-950/80 backdrop-blur-md py-4 border-b border-slate-800/50 mb-12">
                ...
                >
                    <AnimatePresence mode='popLayout'>
                        {filteredArticles.map((article, index) => (
                            ...
                            >
                                <Card className="bg-slate-900/40 border-slate-800 overflow-hidden h-full flex flex-col hover:border-blue-500/30 hover:shadow-2xl hover:shadow-blue-900/10 transition-all duration-300 hover:-translate-y-2">
                                    ...
                                    <div className={`h-52 w-full bg-gradient-to-br ${article.imageGradient} relative overflow-hidden`}>
                                        ...
                                        <div className="absolute top-4 right-4">
                                            <Badge className="bg-slate-950/80 backdrop-blur text-white border-0">
                                    ...
                                    <div className="p-6 flex-1 flex flex-col">
                                        ...
                                        <h2 className="text-xl font-bold text-white mb-3 line-clamp-2 group-hover:text-blue-400 transition-colors leading-tight">
                                            {article.title}
                                        </h2>
