                ...
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground text-sm">إدارة وتتبع فواتيرك</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                {filteredInvoices.length === 0 ? (
                    <div className="text-center py-20">
                        ...
                        <p className="text-muted-foreground">ستظهر فواتيرك هنا عند إصدارها</p>
                    </div>
                ) : (
                        ...
                        {filteredInvoices.map((invoice, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="bg-card/50 border border-border rounded-xl p-6 hover:border-border transition-colors cursor-pointer group"
                                >
                        ...
                        >
                            ...
                            <div className="p-6 space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label className="text-xs text-muted-foreground block mb-1">تاريخ الإنشاء</label>
                                        <p className="font-medium">{formatDate(selectedInvoice.createdAt)}</p>
                                    </div>
                                    {selectedInvoice.paidAt && (
                                        <div className="col-span-2">
                                            <label className="text-xs text-muted-foreground block mb-1">تاريخ الدفع</label>
