        ...
        <div className="min-h-screen bg-background text-foreground">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20 text-center">
                    ...
                    <div className="max-w-2xl mx-auto relative">
                        ...
                        <input
                            ...
                            className="w-full h-14 pl-12 pr-4 bg-card/80 backdrop-blur-sm border border-border rounded-2xl text-foreground placeholder-muted-foreground focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all"
                        />
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
                <div className="flex flex-wrap gap-4 justify-center">
                    <Link href="/docs" className="inline-flex items-center gap-2 px-5 py-2 bg-card border border-border rounded-lg hover:border-purple-500/50 transition-colors text-sm">
                        <BookOpen className="w-4 h-4 text-blue-400" />
                        <span>التوثيق</span>
                    </Link>
                    <Link href="/issues" className="inline-flex items-center gap-2 px-5 py-2 bg-card border border-border rounded-lg hover:border-purple-500/50 transition-colors text-sm">
            ...
            <div className="border-t border-border mt-16">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
                    ...
                    <p className="text-muted-foreground mb-8">اشترك في قناتنا للحصول على أحدث الدروس</p>
                    <a
                        href="https://youtube.com/@hassanalwaqedi-d6c?si=jjhW3k6kAnNW7m-y"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 px-8 py-4 bg-red-600 text-foreground rounded-xl font-semibold hover:bg-red-500 transition-all"
                    >
...
function TutorialCard({ tutorial }: { tutorial: VideoTutorial }) {
    return (
        <div className="group bg-card border border-border rounded-2xl overflow-hidden hover:border-purple-500/50 transition-all hover:shadow-xl hover:shadow-purple-500/10">
            {/* Thumbnail */}
            <div className="relative aspect-video bg-muted">
                ...
                <div className="absolute bottom-2 right-2 px-2 py-1 bg-black/80 rounded text-xs text-foreground">
                    {tutorial.duration}
                </div>
            ...
            {/* Content */}
            <div className="p-5">
                <h3 className="text-lg font-bold text-foreground mb-2 group-hover:text-purple-400 transition-colors line-clamp-2">
                    {tutorial.title}
                </h3>
