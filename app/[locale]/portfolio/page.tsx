                    ...
                    <AnimatePresence mode='popLayout'>
                        {filteredProjects.map((project) => (
                            <motion.div
                                ...
                                className="group"
                            >
                                <Card className="bg-slate-900/50 border-slate-800 overflow-hidden h-full flex flex-col hover:border-blue-500/30 transition-colors duration-300">
                                    ...
                                    <div className={`h-48 w-full bg-gradient-to-br ${project.imageGradient} relative overflow-hidden group-hover:scale-105 transition-transform duration-500`}>
                                        <div className="absolute inset-0 bg-slate-900/20 backdrop-blur-[1px] group-hover:backdrop-blur-none transition-all duration-500" />
                                        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-slate-900/40">
                                            <Button variant="outline" size="sm" className="rounded-full border-white text-white hover:bg-white hover:text-slate-900">
                                                مشاهدة المشروع
                                    ...
                                    <div className="p-6 flex-1 flex flex-col">
                                        ...
                                        <div className="flex flex-wrap gap-2 mt-auto pt-4 border-t border-slate-800/50">
                                            {project.tech.map((t) => (
                                                <span key={t} className="text-[10px] text-slate-500 bg-slate-950 px-2 py-1 rounded border border-slate-800">
                                                    {t}
                                                </span>
                                            ))}
                                        </div>
