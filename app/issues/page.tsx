        ...
        <div className="min-h-screen bg-slate-950 text-white">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20 text-center">
                    ...
                    <div className="max-w-2xl mx-auto relative">
                        ...
                        <input
                            ...
                            className="w-full h-14 pl-12 pr-4 bg-slate-900/80 backdrop-blur-sm border border-slate-800 rounded-2xl text-white placeholder-slate-500 focus:outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-500/20 transition-all"
                        />
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
                <div className="flex flex-wrap gap-4 justify-center">
                    <Link href="/docs" className="inline-flex items-center gap-2 px-5 py-2 bg-slate-900 border border-slate-800 rounded-lg hover:border-yellow-500/50 transition-colors text-sm">
                        <BookOpen className="w-4 h-4 text-blue-400" />
                        <span>التوثيق</span>
                    </Link>
                    <Link href="/tutorials" className="inline-flex items-center gap-2 px-5 py-2 bg-slate-900 border border-slate-800 rounded-lg hover:border-yellow-500/50 transition-colors text-sm">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                {filteredIssues.length === 0 ? (
                    <div className="text-center py-16 bg-slate-900/50 rounded-2xl border border-slate-800">
                        ...
                        <p className="text-slate-500 text-sm mt-2">جرب البحث بكلمات مختلفة</p>
                    </div>
                ) : (
            ...
            <div className="border-t border-slate-800 mt-16">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
                    ...
                    <p className="text-slate-400 mb-8">فريق الدعم الفني جاهز لمساعدتك</p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link
                            href="/dashboard/support"
                            className="px-8 py-4 bg-gradient-to-r from-yellow-600 to-orange-600 text-white rounded-xl font-semibold hover:shadow-lg transition-all"
                        >
                            إرسال تذكرة دعم
                        </Link>
                        <Link
...
function IssueCard({
    ...
    return (
        <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden hover:border-yellow-500/30 transition-all">
            {/* Header */}
            <button
                onClick={onToggle}
                className="w-full px-6 py-5 flex items-center justify-between text-right hover:bg-slate-800/50 transition-colors"
            >
                ...
                <ChevronDown className={`w-5 h-5 text-slate-500 transition-transform flex-shrink-0 mr-4 ${isExpanded ? 'rotate-180' : ''}`} />
            </button>
            ...
            <div className={`overflow-hidden transition-all duration-300 ${isExpanded ? 'max-h-[1000px]' : 'max-h-0'}`}>
                <div className="px-6 pb-6 border-t border-slate-800">
                    ...
                    <div className="mt-6 pt-4 border-t border-slate-800 flex items-center gap-4">
                        <span className="text-sm text-slate-500">هل كان هذا مفيداً؟</span>
